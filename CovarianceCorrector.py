...
def full_cov_correct(hs, gxs, hdata, gdata, weights, Nxs, fvals, fcov, dw_dW_fs, Wvals, verbose=False):
  ...
  HHpH_term = cov_correct(hs, hdata, weights, fvals, fcov, verbose=False)
